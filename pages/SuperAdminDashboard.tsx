...
import { subscribeToSuperAdminStats, subscribeToUsers, addUser, removeUser } from '../services/mockServices';
...
const SuperAdminDashboard: React.FC<{ currentView: ViewType }> = ({ currentView }) => {
  ...
  const [testEmailStatus, setTestEmailStatus] = useState<{ loading: boolean; success?: boolean; error?: string } | null>(null);
